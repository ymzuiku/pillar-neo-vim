...
nmap \@si :NERDTreeTabsFind
nmap \@nu! :set nu!
nmap \@git :GitGutterSignsToggle
nmap \M :MarkdownPreviewStop
nmap \m :MarkdownPreview
nmap \c= :colorscheme 256-jungle
nmap \c- :colorscheme 256-grayvim
nmap \c0 :colorscheme xoria256
nmap \c9 :colorscheme devbox-dark-256
nmap \c8 :colorscheme beauty256
nmap \c7 :colorscheme molokai
nmap \c6 :colorscheme space
nmap \c5 :colorscheme monokai-ym
nmap \c4 :colorscheme github
nmap \c3 :colorscheme bubblegum-256-dark
nmap \c2 :colorscheme bubblegum-256-light
nmap \c1 :colorscheme seoul256
nmap dw <Plug>(Prettier) :w
nmap f9 "9p
nmap f8 "8p
nmap f7 "7p
nmap f6 "6p
...
nnoremap fp :YcmCompleter GoTo
nnoremap fo :YcmCompleter GoToDeclaration
nnoremap fi :YcmCompleter GoToDefinition
nnoremap fu :YcmCompleter GoToDefinitionElseDeclaration
nmap fr :%s/
nmap fm :Marks
nmap f@ @:
nmap f/ :FZF /
...
nmap sv v
nmap sV s
nmap si :NERDTreeTogglew\@si
nmap sI :NERDTreeToggle
nmap sO :set cursorline!
nmap so \@git\@nu!
...
set mouse=a
set report=0
set runtimepath=~/.vim,~/.vim/plugged/nerdtree/,~/.vim/plugged/nerdtree-git-plugin/,~/.vim/plugged/vim-nerdtree-tabs/,~/.vim/plugged/YouCompleteMe/,~/.vim/plugged/CompleteParameter.vim/,~/.vim/plugged/vim-polyglot/,~/.fzf/,~/.vim/plugged/fzf.vim/,~/.vim/plugged/ale/,~/.vim/plugged/vim-javascript/,~/.vim/plugged/vim-jsx/,~/.vim/plugged/typescript-vim/,~/.vim/plugged/ultisnips/,~/.vim/plugged/vim-gitgutter/,~/.vim/plugged/vim-fugitive/,~/.vim/plugged/caw.vim/,~/.vim/plugged/vim-css3-syntax/,~/.vim/plugged/vim-less/,~/.vim/plugged/scss-syntax.vim/,~/.vim/plugged/vim-easymotion/,~/.vim/plugged/undotree/,~/.vim/plugged/markdown-preview.nvim/,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim81,/usr/local/share/vim/vimfiles/after,~/.vim/plugged/CompleteParameter.vim/after,~/.vim/plugged/vim-polyglot/after,~/.vim/plugged/vim-javascript/after,~/.vim/plugged/vim-jsx/after,~/.vim/plugged/ultisnips/after,~/.vim/plugged/caw.vim/after,~/.vim/plugged/vim-css3-syntax/after,~/.vim/plugged/vim-less/after,~/.vim/after
set scrolloff=12
...
let s:l = 681 - ((29 * winheight(0) + 25) / 51)
