...
call s:h("WarningMsg",    { "fg": s:black })
...
if g:materialmonokai_custom_lint_indicators == 1
  " call s:h("ALEErrorSign",   { "bg": s:black,    "fg": s:darkgrey })
  call s:h("ALEWarningSign", { "bg": s:black, "fg": s:darkgrey })
...
" call s:h("SyntasticWarningSign",    { "bg": s:black })
